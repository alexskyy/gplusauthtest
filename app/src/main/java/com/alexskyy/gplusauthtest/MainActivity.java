...
package com.alexskyy.gplusauthtest;
...
public class MainActivity extends FragmentActivity implements
    ...
    @ViewById
    Button revoke_access_button;
    @ViewById
    TextView sign_in_status;

    @ViewById
    ImageView sign_in_icon;
    @ViewById
    ListView circles_list;
...
//        circles_list = (ListView) findViewById(R.id.circles_list);
    ...
    protected void onStart() {
        super.onStart();
        // Button listeners
        revoke_access_button.setOnClickListener(clicker);
        sign_out_button.setOnClickListener(clicker);
        sign_in_button.setOnClickListener(clicker);
        ...
        circles_list.setAdapter(mCirclesAdapter);
            ...
            if (!mGoogleApiClient.isConnecting()) {
                ...
                switch (v.getId()) {
                    case R.id.sign_in_button:
                        sign_in_status.setText(R.string.status_signing_in);
    ...
    public void onConnected(Bundle connectionHint) {
        ...
        revoke_access_button.setEnabled(true);
        ...
        sign_in_status.setText(String.format(
                getResources().getString(R.string.signed_in_as),
                currentUser.getDisplayName()));
//        if   ( currentUser.getImage().hasUrl() ) {
//            Uri imageUri = Uri.parse(currentUser.getImage().getUrl());
//            sign_in_icon.setImageURI(imageUri);
//        }
